<?
	...
	$NewReport->MonthlyReport($StartDate, $EndDate, $MonthlyExpenseArray, $ArrayCount, $User->GetAccountID());
...
{
	if($YearBuffer != substr($MonthlyExpenseArray[$x]["Month"], 0, 4))
	{
		$YearBuffer = substr($MonthlyExpenseArray[$x]["Month"], 0, 4);
