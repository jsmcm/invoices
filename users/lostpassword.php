...
<font color="red">You have entered incorrect login credentials, please retry, or request a new password</font>
<p>
...
<form name="AdminLogin" method="post" action="SendLogin.php">
